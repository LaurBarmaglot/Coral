...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'logo',
                type: 'image',
                rect: ['-9px', '-10px','263px','80px','auto', 'auto'],
    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid70", tween: [ "style", "${_logo}", "left", '-41px', { fromValue: '-9px'}], position: 3040, duration: 250 },
                ...
                { id: "eid68", tween: [ "transform", "${_logo}", "scaleX", '0.75', { fromValue: '1'}], position: 3040, duration: 250 },
                ...
                { id: "eid69", tween: [ "transform", "${_logo}", "scaleY", '0.75', { fromValue: '1'}], position: 3040, duration: 250 },
                { id: "eid71", tween: [ "style", "${_logo}", "top", '-15px', { fromValue: '-10px'}], position: 3040, duration: 250 },
